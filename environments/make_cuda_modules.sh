...
####################################################################################################
# Install and configure CUDA 12.8 for Modulefiles
####################################################################################################
{
...
sudo touch /usr/share/modules/modulefiles/cuda/12.8
sudo tee /usr/share/modules/modulefiles/cuda/12.8 > /dev/null <<EOF
#%Module1.0
##
## cuda 12.8 modulefile
##
...
module-whatis "sets up environment for CUDA 12.8"

set version 12.8.0
set root /usr/local/cuda-12.8
...
EOF
    ...
    echo "CUDA 12.8 installation failed."
}
