...
def extract_and_save_feature_pipeline(args):
    ...
    if not args.images_are_RGB:
        ...
        def load_image(self, idx, args):
            ...
            image = imread(path)
            print("begining of load image:", image.shape)
            image = image[:, :, selected_channels]
            print("Selected channels: ", selected_channels)
            print("image shape after channel selection: ", image.shape)
            ...
            if args.center_crop:
                ...
                image = image.numpy()
            print("end of load image:", image.shape)
            return image
        ...
        class Multichannel_dataset(datasets.ImageFolder):
            def __getitem__(self, idx):
                ...
                print("image_np shape after normalization: ", image_np.shape)
